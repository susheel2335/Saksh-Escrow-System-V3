...
<?php
 ...
 global $wpdb;
$wpdb->query($wpdb->prepare("INSERT INTO {$wpdb->prefix}invoice ( ship_to,amount, user_id ,description,product_id,customer_id,bill_to,currency,fee,company_id) VALUES ( %s,%s,%s,%s,%s,%s,%s,%s,%s,%s)", array(
            $ship_to,
            $amount,
            $user_id,
            $description,

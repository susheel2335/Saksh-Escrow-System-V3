...
$results = $wpdb->get_results($wpdb->prepare("SELECT * FROM {$wpdb->prefix}bank where user_id=%s  and company_id=%s",$user_id,$company->company_id));
       
           
//  $sql = "SELECT * FROM {$wpdb->prefix}bank where user_id= ".$user_id;

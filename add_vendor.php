       ...
       if (isset($_POST['submit']) and $_POST['action'] == 'vendor_system')
        {
           ...
           $wpdb->query($wpdb->prepare("INSERT INTO {$wpdb->prefix}vendor ( vendor_name,vendor_email, user_id,vendor_type,mobile_no,first_name,last_name,country,address,city,state,zip_code ,pan_number,gst_number,company_id) VALUES (%s ,%s,%s,%s ,%s,%s,%s ,%s,%s,%s ,%s,%s,%s,%s,%s)", array(
            $vendor_name,
            $vendor_email,
            $user_id,
            $vendor_type,
...
<label for="title"><?php _e('vVendor Type', 'aistore'); ?></label><br>
...
<label for="Individual">Individual</label><br><br>
  ...
  <label for="title"><?php _e('Vendor Display Name', 'aistore'); ?></label><br>
  <input class="input" type="text" id="vendor_name" name="vendor_name"><br>


  <label for="title"><?php _e('Email', 'aistore'); ?></label><br>
  <input class="input" type="text" id="vendor_email" name="vendor_email"><br><br>
